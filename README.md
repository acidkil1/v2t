...
**CUDA не заводится, ошибка `cublas64_12.dll is not found`**  
Утилита автоматически ставит нужные библиотеки в venv и регистрирует их. Если всё равно падает — она продолжит на CPU, просто медленнее. Принудительно: `--device cpu`.
